...
class EnemyDictionaryDetail extends StatelessWidget {
  final Map document;
	EnemyDictionaryDetail({Key key, this.document}) : super(key: key);
	...
	Widget build(BuildContext context) {
        ...
        body: EnemyDictionaryDetailPage(document: document),
		);
	}
}

class EnemyDictionaryDetailPage extends StatefulWidget {
  final Map document;
  EnemyDictionaryDetailPage({Key key, this.document}) : super(key: key);

  EnemyDictionaryDetailPageState createState() => new EnemyDictionaryDetailPageState(document: document);
}

class EnemyDictionaryDetailPageState extends State<EnemyDictionaryDetailPage> {
  final Map document;
	EnemyDictionaryDetailPageState({this.document});
