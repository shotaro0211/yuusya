								...
								children: snapshot.data.documents.map((DocumentSnapshot document) {
						          ...
						          leading: Image.asset('assets/icons/sword.png'),
											...
											Row(
												...
												children: <Widget>[
													new Text('${(document['money'] * 0.5).round()}文', style: TextStyle(fontSize: 15.0,)),
											...
											Column(
												...
												children: <Widget>[
													...
													new Text('${document['describe']}/${document['type']}/Lv${document['category']}', style: TextStyle(fontSize: 10.0,)),
												]
											),
											onTap: () {
														...
														actions: <Widget>[
															...
															FlatButton(
																...
																onPressed: () {
																	...
																	if (battled == false) {
																		Firestore.instance.collection('users').document(user_info.getString('id')).collection('units').document(document.documentID).delete();
